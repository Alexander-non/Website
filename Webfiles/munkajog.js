...
function fogalom() {
    x++;
    if (x % 2 == 0) {
        document.getElementById("probaido").innerHTML = "";
        document.getElementById("gyakornok").innerHTML = "";
        document.getElementById("felmondasi-ido").innerHTML = "";
        document.getElementById("beteg-szabadsag").innerHTML = "";
        document.getElementById("cafeteria").innerHTML = "";
        document.getElementById("kollektiv-szerzodes").innerHTML = "";
    } else {
