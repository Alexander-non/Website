...
function ShowHide(elementsClass) {
    if (Pressed == true) {
        ...
        document.getElementById("kollektiv-szerzodes").innerHTML = '<b> Kollektív szerződés: </b> Az igényes munka fontos egy ember számára hisz az mutatja be az embert saját maga helyett bár az igényes munka nem tud beszélni mégis tökéletesen mutatja készítőjének hozzáállását és belefektetett idejét tehát egy munka minél igényesebb annál jobb.'
